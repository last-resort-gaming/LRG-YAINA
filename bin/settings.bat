...
set SERVER_MODS="ServerMods\@Advanced Rappelling;ServerMods\@Advanced Sling Loading;ServerMods\@Advanced Towing;ServerMods\@Advanced Urban Rappelling;D:\Arma3BRC\BRC_HELPER\ARMA 3\@brc_helper"
