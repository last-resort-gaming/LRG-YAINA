...
set SERVER_MODS="!Workshop\@Advanced Rappelling;!Workshop\@Advanced Sling Loading;!Workshop\@Advanced Towing;!Workshop\@Advanced Urban Rappelling;LocalMods\@A3Log;LocalMods\@inidbi2;LocalMods\yaina-app.0\@yaina"
