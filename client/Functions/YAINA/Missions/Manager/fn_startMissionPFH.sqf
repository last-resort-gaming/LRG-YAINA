...
params ["_missionID", "_missionType", "_stage", "_missionName", "_parentMissionID", "_markers", "_groups", "_vehicles", "_buildings", "_pfh", "_pfhDelay", "_pfhArgs"];

// Send it all to the server...along with our profileName
[
    profileName,
    _missionID, _missionType, _stage, _missionName, _parentMissionID, _markers, _groups, _vehicles, _buildings, _pfh, _pfhDelay, _pfhArgs
