...
force force ace_map_gestures_maxRange = 50;
...
force force ace_viewdistance_objectViewDistanceCoeff = 3;
...
force force acex_volume_reduction = 6;
...
force force ace_advanced_fatigue_performanceFactor = 5.0;
force force ace_advanced_fatigue_recoveryFactor = 5.0;
