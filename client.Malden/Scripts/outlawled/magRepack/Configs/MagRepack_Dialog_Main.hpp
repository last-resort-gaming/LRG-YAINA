...
class MagRepack_Dialog_Main
{
	...
	class Controls
	{
		...
		class MR_Logo: outlw_MR_RscPicture
		{
			...
			text = "Scripts\outlawled\magRepack\Images\MR_logo.paa";
		...
		*/
		...
		{
			idc = 2210;
			text = "Scripts\outlawled\magRepack\Images\MR_SourceGradient.paa";
		...
		{
			idc = 2211;
			text = "Scripts\outlawled\magRepack\Images\MR_TargetGradient.paa";
